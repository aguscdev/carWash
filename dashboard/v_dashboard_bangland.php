...
<div class="container">
    ...
    <div class="panel panel-default"><font face="Britannic Bold" size="5">&nbsp;&nbsp;BANGLAND</font>
      <div class="panel-body">
        <h5>
          ...
          <h5>
            <?php
              $data = mysqli_query($koneksi, "SELECT DISTINCT bangland_personil,tanggal FROM mon_bangland where id = $id");
              $d = mysqli_fetch_assoc($data);
            ?>
