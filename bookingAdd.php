...
<body>
    ...
    <h3 class="text-center"><font face="Cooper Black" size="5">Booking</font></h3>

	<div class="panel panel-default">
		<div class="panel-body">
			<form method="post" action="action_bookingAdd.php">
			  ...
			  <div class="form-group col-md-6">
                  ...
                  <input type="text" name="jenis_kendaraan" class="form-control" id="jenis_kendaraan" placeholder="Masukan Jenis Kendaraan" required>
              </div>
              <div class="form-group col-md-6">
                  <label for="no_kendaraan">No Kendaraan</label>
                  <input type="text" name="no_kendaraan" class="form-control" id="no_kendaraan" placeholder="Masukan No Kendaraan" required>
              </div>
			  <!-- <div class="form-group col-md-6">
              ...
              <div class="form-group col-md-6">
                <label for="harga">Harga Paket Booking</label>
			  ...
			  <div class="form-group">
			      ...
			      <input type="hidden" name="status" class="form-control" id="status" value="Antri" required>
			  </div>
