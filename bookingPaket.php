    ...
    <div class="thumbnail">
      ...
      <div class="panel-heading">
        ...
        <div class="panel-body">
          ...
          <!-- <font face="Britannic Bold" size="5"><a href="bookingAdd.php?id_paket=<?= $d['id_paket']; ?>" class="small-box-footer">
              &nbsp;&nbsp;Klik Untuk Booking <i class="fa fa-arrow-circle-right"></i>
          </a></font> -->
          <font face="Britannic Bold" size="5"><a href="bookingAdd.php" class="small-box-footer">
              &nbsp;&nbsp;Klik Untuk Booking <i class="fa fa-arrow-circle-right"></i>
          </a></font>
        </div>
        </div>
